...
public class Validator {
	...
	public static int getInt(Scanner scnr, String prompt) {
		...
		while (!scnr.hasNextInt()) {
			...
			System.out.println("That is not one of the options. Please try again. (enter a number 1-10)");
	...
	public static int getIntBetween(Scanner scnr, String prompt, int min, int max) {
		...
		do {
			...
			if (number < min) {
				isValid = false;
				System.out.println("That is not one of the options. Please try again. (enter a number 1-5) ");
			} else if (number > max) {
				isValid = false;
				System.out.println("That is not one of the options. Please try again. (enter a number 1-5) ");
			} else {
